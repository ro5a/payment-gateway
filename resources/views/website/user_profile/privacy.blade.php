...
<section >
    <h2 class="display-2">إدارة إعدادات الخصوصية الخاصة بك</h2>
    <div class="card w-50 mt-5 " >
        <div class="card-body ">
          <h5 class="card-title display-4 m-5 fw-bold">اذونات</h5>
          <div class="d-flex justify-content-start ">
       
       <p class="fs-3">تتبع البيانات والأذونات التي تشاركها مع التطبيقات والمواقع التي تمتلكها</p>
