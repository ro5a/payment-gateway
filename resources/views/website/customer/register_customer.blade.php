      ...
      <form class="login-form row container g-3s" action="{{ route('register_customer') }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input name="confirm_password" placeholder="تاكيد كلمة المرور" type="password" class="fs-4 form-control @error('confirm_password') is-invalid @enderror" id="inputEmail4" value="{{ old('confirm_password') }}">
